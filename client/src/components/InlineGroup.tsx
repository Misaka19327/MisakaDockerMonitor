  ...
  return (
    <div className="flex">
      ...
      >
        ...
        {/* Group label */}
        <div className={`sticky top-0 z-10 ${color.text} text-[10px] font-medium leading-tight pt-1 pl-1 truncate max-w-[32px]`} title={groupKey}>
          {collapsed ? <ChevronRight className="inline h-3 w-3 -ml-0.5 mr-0.5" /> : <ChevronDown className="inline h-3 w-3 -ml-0.5 mr-0.5" />}
